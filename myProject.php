...
while ( $row3 = $res->fetch_array()) { 
  $name1 = $row3['name']; }
  $sql2 = "SELECT * FROM project_allocation WHERE name= '$name1' AND status =1 AND approved_status =0 ORDER BY `s_date` DESC";
...
while ( $row3 = $res->fetch_array()) { 
  $name1 = $row3['name']; 
                                            ...
                                            $sql2 = "SELECT * FROM project_allocation WHERE name= '$name1' AND status =1 AND approved_status =1 ORDER BY `s_date` DESC";
                                            $result2 = $connect->query($sql2);
