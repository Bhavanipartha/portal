...
if (mysqli_connect_errno())
{
    echo "Failed to connect to MySQL: " . mysqli_connect_error();
        ...
        $sql = "INSERT INTO quote (`quote`,`datee`) 
        VALUES ('$quote', '$datea')";
...
echo "<script>alert('Quote added!');</script>";
echo "<script>window.location.href='addQuote.php'</script>";
  ...
  <aside id="sidebar" class="sidebar" style="margin-top: 85px; ">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      ?>
        ...
        <li class="nav-item">
          <a class="nav-link collapsed " data-bs-target="#user-nav" data-bs-toggle="collapse" href="#user-nav">
        ...
        <li class="nav-item">
          <a class="nav-link " href="addQuote.php">
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      ...
      <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800 mt-3" style="margin-left: 10px;">Add Quote</h1>
      </div>
      ...
      <div class="container-fluid">
        ...
        <div class="row justify-content-center">
          ...
          <div class="card">
            ...
            <div class="card-body">
              <h5 class="card-title">Quote for the day</h5>

              <form method="get" action="addQuote.php"  >
                ...
                <div class="row g-3 mb-2 mt-2">
                  <div class="col-md-4 col-sm-12">
                    <div class="form-floating">
                      <input type="date" class="form-control" id="user" name="datea" placeholder="Your Name"  required>
                  ...
                  <div class="col-md-8 col-sm-12">
                    <div class="form-floating">
                      <textarea class="form-control" id="pass" name="quote" placeholder="Your ROllNo"  required></textarea>
                      <label for="floatingRollNo">Quote</label> 
                      <center>
