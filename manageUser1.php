...
<ul class="sidebar-nav" id="sidebar-nav">
  ...
  ?>
    <li class="nav-item">
      <a class="nav-link " href="manageUser1.php">
...
<?php } ?>
  ...
  <br><br><br><br>
    ...
    <div class="pagetitle">
          ...
          <h4 class="ml-4 mt-4">Employee details</h4><br><br>
                <!-- Begin Page Content -->
                <div class="container-fluid">
                        ...
                        <table class="table table-striped" id="dataTable">
                            ...
                            <?php
                                                ...
                                                $sql = "SELECT * FROM users WHERE status = 1 AND (role='Employee' || role='S-Employee')";
                                                $result = mysqli_query($connect, $sql);
...
function editUser(){
    ...
    $.ajax({
        method: "POST",        
        url: "showUser.php",
        data: {user_id:id}, // serializes the form's elements.        
...
$("#editUserFrm").submit(function(e) {
    ...
    // alert("1");
    let myform = document.getElementById("editUserFrm");
