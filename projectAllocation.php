        ...
        <div class="row justify-content-center">
          <div class="card">
            <div class="container p-4" style="overflow:auto">
              ...
              <br><br>
              <form id="delayedForm" method="post" action="allocateProject.php">
                            ...
                            <thead>
                              <tr>
                                ...
                                <th class="text-center">
                                  Start Date<span class="str">
                                    <font color="red">*</font>
                                  </span>
                                </th>
                                <th class="text-center">
                                  End Date<span class="str">
                                    <font color="red">*</font>
                                  </span>
                                </th>
                                <th class="text-center">
                                  Employee<span class="str">
                                    <font color="red">*</font>
                                  </span>
                                </th>
                                ...
                                <td id="col3">
                                  <div class="col-md-12 col-lg-3 col-sm-12 col-xl-3">
                                    <div class="form-group">
                                      ...
                                      $sql1 = "SELECT name FROM employee_details where status=1 AND supervisor ='$name' and name != '-'";
