...
if (isset($_POST["name"])) {
  ...
  if ($name == 'all') {
    ...
    if (isset($_POST["generate_pdf"])) {
      ...
      $content = '';
      $content .= ' <span align="center"><img src="./assets/img/genAI.jpg" alt="" width="40" height="40" >  </span>
                  ...
                  <div class="form-group">
                    <div class="row">
                      ...
                      <div class="col-sm-4">
                        ...
                        $sql = "SELECT DISTINCT(name) FROM employee_details WHERE status = 1 AND name != '-' AND role NOT IN ('Super-admin', 'Admin')";
