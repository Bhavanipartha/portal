...
<li class="nav-item">
          ...
          <li class="nav-item">
          <a class="nav-link " href="bestPerformer.php">
...
<main id="main" class="main">
  <br><br><br><br>
  <div class="pagetitle">
    <h1 class="h3 mb-0 text-gray-800 mt-3">Best Performer Selection</h1>
  </div><br>

  <div class="card p-4">
     <br>
    <form action="best_performer.php" method="post" onsubmit="return validateSelection();">

      <div class="row mb-4">
        <div class="col-md-6">
          <label>Select Best Performer 1</label>
          <select class="form-select" name="performer1" required>
            <option value="" disabled selected>-- Choose Employee --</option>
            <?php
              $sql ="SELECT name FROM employee_details WHERE name != '-' AND role IN ('S-Employee', 'Employee', 'S-admin')";
              $result= mysqli_query($connect, $sql);
              while ($row = mysqli_fetch_array($result)) {
        ...
        <div class="col-md-6">
          <label>Select Best Performer 2</label>
          <select class="form-select" name="performer2" required>
            <option value="" disabled selected>-- Choose Employee --</option>
            <?php
 ...
 <br> <br>
 <center><button type="submit" class="btn btn-primary"  style ="background-color: #333d97;"  id="success" name="success">Submit</button>
...
function validateSelection() {
  const p1 = document.querySelector('[name="performer1"]').value;
  const p2 = document.querySelector('[name="performer2"]').value;
  if (p1 === p2) {
    alert("Best Performer 1 and 2 cannot be the same person.");
    return false;
  }
  return true;
}
