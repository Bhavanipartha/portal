        ...
        <div class="row justify-content-center">
          ...
          <div class="card" >
            ...
            <div class="card-body">
                  ...
                  $sql ="SELECT * FROM employee_details WHERE email = '".$_SESSION['uname']."' and name='-'";
                  $result = mysqli_query($connect, $sql);
                  $n = $result->num_rows;
                  if($n != 0){
  ...
  <div class="form-floating">
    ...
    <label for="dob">Date of Birth*</label>
                ...
                <div class="col-md-4 col-sm-12">
                  ...
                  <div class="col-md-4 col-sm-12">
                    <div class="form-floating">
                      <input type=""  class="form-control" id="Famobno" name="addr2" placeholder="Your Name" onblur="validate('famobno_result', this.value)"  >
...
<?php }else{
   $sql = "SELECT * FROM employee_details WHERE email = '" . $_SESSION['uname'] . "'";
$result = mysqli_query($connect, $sql);
$n = $result->num_rows;
if ($n != 0) {
    while ($row = mysqli_fetch_assoc($result)) {
        echo "<center><br><br><div style='text-align: center;'>";
        
        // Display the employee's image in a round shape above the details
        echo "<div>";
        echo "<img src='./images/" . $row['photo_path'] . "' alt='Employee Image' style='border-radius: 50%; width: 200px; height: 200px;'>";
        echo "</div><br>";

        // Display employee details below the image
        echo "<div>";
        echo "<b>Name</b>: " . $row['name'] . "<br>";
        echo "<b>Role</b>: " . $row['designation'] . "<br>";
        echo "<b>Supervisor</b>: " . $row['supervisor'] . "<br>";
        echo "</div>";
...
<script>
  $('#dob').datepicker({
    ...
    changeMonth: true,
    changeYear: true,
    startView: 2,              // opens in "years" view
  });
</script>
<!-- Vendor JS Files -->
